...
@section('admin')
    ...
    <div class="main-content">
        <div class="page-title-area" style="margin-top: 20px;">
            <div class="row align-items-center">
                <div class="col-sm-12">
                    ...
                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#addCategoryForm"
                        style="text-decoration: none; color: white;border: 0px solid; float: inline-end; background-color: #272727;">
                        Add Category
                    </button>
                </div>
            </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <a class="btn btn-danger" href="{{ url('importCategory') }}"
                        style="text-decoration: none; color: white;border: 0px solid; float: right; background-color: #0069D9; margin-top: -17px;">
                        Import
                    </a>
    ...
    <!--add Category Model-->
    <div class="modal fade" id="addCategoryForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="updateCategoryForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom-0">
                    ...
                    'columns': [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row, meta) {
                                return '<span style="float:left; margin-left: 25%; cursor: pointer" class="editCategory" data-toggle="modal" data-target="#updateCategoryForm" data-id="' +
                                    data +
                                    '"><i class="fa fa-edit fa-2x"></i></span><span class="DeleteButton" style="float:right; margin-right: 25%" data-id="' +
                                    data +
